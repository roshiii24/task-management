...
const htmltaskContent = ({ id, title, description, type, url }) => `
    <div class="col-md-6 col-lg-4 mt-3" id=${id} key=${id}>
        <div class="card shadow-sm task__card">
            ...
            <div class="card-body">
                ${
                    url ? `<img width='100%' height="200px" style="object-fit:cover; object-position:center" src=${url} alt='card image cap' class="img-fluid place__holder_image mb-3"/>` :
                    `<img width='100%' height="200px" style="object-fit:cover; object-position:center" src="https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png" alt='card image cap' class="img-fluid place__holder_image mb-3"/>`
                }
...
const htmlModalContent = ({ id, title, description, url }) => {
    ...
    return `
        <div id=${id}>
            ${url ? `<img width='100%' src=${url} alt='card image cap' class="img-fluid place__holder_image mb-3"/>` :
            `<img width='100%' src="https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png" alt='card image cap' class="img-fluid place__holder_image mb-3"/>`
            }
